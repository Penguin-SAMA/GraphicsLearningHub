...
int main() {
    ...
    // ------------------------------------
    Shader ourShader(
        "E:\\GraphicsLearningHub\\LearnOpenGL\\src\\shader.vs",
        "E:\\GraphicsLearningHub\\LearnOpenGL\\src\\shader.fs"); // you can name your shader
    ...
    unsigned char* data = stbi_load(
        "E:\\GraphicsLearningHub\\LearnOpenGL\\images\\container.jpg",
        &width,
        &height,
        &nrChannels,
        0);
    ...
    data = stbi_load(
        "E:\\GraphicsLearningHub\\LearnOpenGL\\images\\awesomeface.png",
        &width,
        &height,
        &nrChannels,
        0);
